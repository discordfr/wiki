...
<Tabs>
  <TabItem value="tag-badge" label="Tag et Badge" default>
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-tag-badge.webp" width="1920" height="1200" alt="Configuration tag et badge de guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="banniere" label="Bannière">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-banniere.webp" width="1920" height="1200" alt="Configuration bannière de guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="description" label="Description">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-description.webp" width="1920" height="1200" alt="Configuration description de guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="caracteristiques" label="Caractéristiques">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-caracteristiques.webp" width="1920" height="1200" alt="Configuration caractéristiques de guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="themes" label="Thèmes">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-themes.webp" width="1920" height="1200" alt="Configuration thèmes de guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="style" label="Style de jeu">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-style-de-jeu.webp" width="1920" height="1200" alt="Configuration style de jeu guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
  <TabItem value="jeux" label="Liste de jeux">
    <Thumbnail src="https://i.dfr.gg/guilde-configuration-jeux.webp" width="1920" height="1200" alt="Configuration liste de jeux guilde Discord" title="Cliquez pour voir en plein écran" loading="lazy" />
  </TabItem>
</Tabs>
