...
Les forums sur Discord sont des canaux de discussion. Les forums ont diverses utilisations en fonction des communautés mais leur fonctionnement est le même. 
...
:::note
Les tags, bien que généralement optionnels, peuvent être rendus obligatoires par l'administrateur du forum s'il a configuré cette option. Dans ce cas, les utilisateurs sont tenus d'ajouter au moins un tag à leurs posts.
:::
