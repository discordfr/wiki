...
keywords:
  ...
  - permissions
  - membres
description: Ces permissions permettent de gérer les membres du serveur
contributors: [wolfyzdbois]
---

Ces permissions permettent de gérer les membres du serveur ainsi que la création d'invitation.
...
Il est cependant possible de le débannir via l'onglet "Bannissements" des paramètres du serveur.
