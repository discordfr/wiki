...
Il s'agit principalement de réseaux sociaux, de plateformes de streaming ainsi que de jeux. Ces connexions sont officielles, et ne sont pas à confondre avec les [applications tierces](https://dfr.gg/wiki/parametres-compte/connexions-compte/applications-autorisees/).
...
Voici la liste des sites avec lesquels il est possible de relier son compte :
 ...
 - Le service de streaming musical [Spotify](https://spotify.com), vous pouvez retrouver un [article dédié à cette connexion ici](https://dfr.gg/wiki/parametres-compte/connexions-compte/connexion-spotify/).
